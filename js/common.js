...
function initNotifications() {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (e.target.closest('#android-download-button')) {
            ...
            let cnApk = `https://source.melonai.com.cn/app-melon-release-V_1_5_1.apk?v=${Date.now()}`
            let otherApk = `https://source.melonai.com.cn/app-melons-release-V_1_5_1.apk?v=${Date.now()}`
            if (window.location.hostname.indexOf(melonsAIHost) === -1) {
                // 国内
